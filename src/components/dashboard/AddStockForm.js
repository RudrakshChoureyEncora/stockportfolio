...
const AddStockForm = () => {
  ...
  const popularStocks = [
    { symbol: "TATA", name: "TATA Inc.", price: 235.5 },
    { symbol: "GODREJ", name: "GODREJ Corp.", price: 475.0 },
    { symbol: "LUCAS", name: "LUCAS", price: 155.75 },
    { symbol: "PARIBAS", name: "PARIBAS.", price: 335.2 },
    { symbol: "ENCORA", name: "ENCORA.", price: 495.3 },
  ];
  const validateForm = () => {
    const newErrors = {};
